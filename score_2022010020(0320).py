#사회학과 2022010020 최수민
#5명 학생의 3과목 점수 입력받고 총점과 평균과 학점 출력하는 프로그램

"""name1=input("이름을 입력하시오:")
x=input(name1,"의 국어 점수를 입력하시오:")
y=input(name1,"의 수학 점수를 입력하시오:")
z=input(name1,"의 영어 점수를 입력하시오:")
kor1,mat1,eng1=int(x),int(y),int(z)"""
...
def calculate_rank(students):       ##등수를 계산하는 함수
...
for i in range(5):    ##학생이 5명이기에 5번 반복
  ...
  scores = []
  for j in range(3):  ##3과목을 입력해야 하기에 3번 반복
      score = float(input(f"{name} 학생의 {j+1}번째 과목 점수를 입력하세요: "))
      scores.append(score)
